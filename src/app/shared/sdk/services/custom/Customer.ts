...
export class CustomerApi extends BaseLoopBackApi {
   ...
   * @param {any} id Customer id
   *
   * @param {any} fk Clave foránea para comments
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
  ...
  /**
   * Buscar un elemento relacionado por id para favorites.
   *
   * @param {any} id Customer id
   *
   * @param {any} fk Clave foránea para favorites
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
  ...
  /**
   * Suprimir un elemento relacionado por id para favorites.
   *
   * @param {any} id Customer id
   *
   * @param {any} fk Clave foránea para favorites
  ...
  /**
   * Actualizar un elemento relacionado por id para favorites.
   *
   * @param {any} id Customer id
   *
   * @param {any} fk Clave foránea para favorites
  ...
  /**
   * accessTokens consultas de Customer.
   *
   * @param {any} id Customer id
   *
   * @param {object} filter 
  ...
  /**
   * Recuentos accessTokens de Customer.
   *
   * @param {any} id Customer id
   *
  ...
  /**
   * comments consultas de Customer.
   *
   * @param {any} id Customer id
   *
   * @param {object} filter 
  ...
  /**
   * Suprime todos los comments de este modelo.
   *
   * @param {any} id Customer id
   *
   * @returns {object} An empty reference that will be
  ...
  /**
   * Recuentos comments de Customer.
   *
   * @param {any} id Customer id
   *
   * @param {object} where Criteria to match model instances
  ...
  /**
   * favorites consultas de Customer.
   *
   * @param {any} id Customer id
   *
   * @param {object} filter 
  ...
  /**
   * Crea una nueva instancia en favorites de este modelo.
   *
   * @param {any} id Customer id
   *
   * @param {object} data Request data.
  ...
  /**
   * Suprime todos los favorites de este modelo.
   *
   * @param {any} id Customer id
   *
   * @returns {object} An empty reference that will be
  ...
  /**
   * Recuentos favorites de Customer.
   *
   * @param {any} id Customer id
   *
   * @param {object} where Criteria to match model instances
